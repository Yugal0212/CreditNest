...
const featureItems = [
  { icon: BookOpen,   title: 'Credit Ledger System',  description: 'Maintain complete transaction history for each customer with full audit trail.' },
  { icon: Lock,       title: 'OTP Secure Login',       description: 'Bank-level security with one-time password verification at every login.' },
  { icon: BarChart3,  title: 'Monthly Reports',        description: 'Visual analytics and detailed reports of your entire credit business.' },
  { icon: CreditCard, title: 'Payment Tracking',       description: 'Real-time payment updates and pending dues tracking at a glance.' },
  { icon: Globe,      title: 'Multi-language Support', description: 'English, Hindi, Gujarati — interact in the language most comfortable to you.' },
  { icon: Smartphone, title: 'Install as Mobile App',  description: 'Progressive Web App that installs on any device and works offline too.' },
]

const steps = [
  { icon: Store,      title: 'Register Shop',    description: 'Create your shop account in under 60 seconds with zero paperwork.' },
  { icon: Users,      title: 'Add Customers',    description: 'Add your regular credit customers to the system instantly.' },
  { icon: Plus,       title: 'Add Daily Credit', description: 'Record credit transactions as they happen, in real time.' },
  { icon: TrendingUp, title: 'Collect Payment',  description: 'Track pending dues and collect payments with smart reminders.' },
  { icon: BarChart3,  title: 'View Reports',     description: 'Get powerful insights into your credit business, monthly.' },
]

const testimonials = [
  { name: 'Ramesh Patel',  role: 'Kirana Shop Owner, Ahmedabad', avatar: 'RP', rating: 5, comment: 'CreditNest has made managing my credit customers so much easier. I no longer need to maintain a paper register!' },
  { name: 'Sunita Sharma', role: 'Canteen Owner, Jaipur',        avatar: 'SS', rating: 5, comment: 'The multilingual support is fantastic. I prefer using it in Hindi and it works perfectly. My dues collection improved by 40%!' },
  { name: 'Mohan Verma',   role: 'Grocery Store, Delhi',         avatar: 'MV', rating: 5, comment: 'Monthly reports help me understand my business better. I know exactly who owes me money and how much.' },
]
...
export default function Page() {
  ...
  const handleLang = (code: string) => { setActiveLang(code); triggerGoogleTranslate(code) }
    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden font-sans transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-[68px]">
            ...
            <Link href="/" className="flex items-center gap-2 group shrink-0">
              <div className="size-9 bg-gradient-to-tr from-primary to-secondary rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-primary/20">
                CN
              </div>
              <div>
          ...
          {mobileOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-1">
                ...
                <div className="pt-2 border-t border-border flex justify-center"><LanguageSwitcher /></div>
                <div className="flex gap-2 pt-3 border-t border-border">
                  <Link href="/login" className="flex-1" onClick={() => setMobileOpen(false)}>
                    <button className="w-full px-4 py-2.5 rounded-xl text-[13px] font-bold border border-border bg-card text-foreground hover:bg-accent transition-all">Login</button>
                  </Link>
                  <Link href="/register" className="flex-1" onClick={() => setMobileOpen(false)}>
                    <button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-bold py-2.5 text-[13px] transition-all shadow-sm">Get Started</button>
                  </Link>
                </div>
              </div>
            </motion.div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[11px] font-black uppercase tracking-[0.26em] text-primary">Trusted by 5,000+ businesses across India</span>
                  </motion.div>
                  ...
                  >
                    Track customer dues, send smart reminders, and manage your ledger like a pro. Built exclusively for modern Indian businesses.
                  </motion.p>
                ...
                >
                  ...
                  <div className="relative rounded-2xl border border-border shadow-2xl overflow-hidden bg-card">
                    ...
                    <div className="p-5 bg-card/50">
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-4">
                        {[
                          { label: 'Total Credit', val: '₹1,24,500', color: 'text-primary', bg: 'bg-primary/5' },
                          { label: 'Collected',    val: '₹98,200',   color: 'text-green-500', bg: 'bg-green-500/5' },
                          { label: 'Pending',      val: '₹26,300',   color: 'text-yellow-500', bg: 'bg-yellow-500/5' },
                        ].map((s) => (
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="col-span-2">
                          <div className="bg-card rounded-xl border border-border p-3 shadow-sm">
                            <p className="text-[9.5px] font-black uppercase tracking-wider text-muted-foreground mb-3">Monthly Collection</p>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[11px] font-black text-foreground">↑ 40% collection</p>
                      <p className="text-[9.5px] text-muted-foreground font-medium">this month</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[11px] font-black text-foreground">OTP Verified</p>
                      <p className="text-[9.5px] text-muted-foreground font-medium">bank-grade security</p>
                    </div>
                  </motion.div>
                </motion.div>
              </div>
        ...
        <section className="bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              {[
                { value: '5,000+',  label: 'Active Stores',    sub: 'across India',          icon: Store      },
                { value: '₹200M+', label: 'Credit Tracked',   sub: 'monthly volume',         icon: CreditCard },
                { value: '99.9%',  label: 'Uptime SLA',        sub: 'guaranteed reliability', icon: ShieldCheck },
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              >
                ...
                <span className="text-[10.5px] font-black uppercase tracking-[0.26em] text-primary">Platform Features</span>
              </motion.div>
              <motion.h2
              ...
              >
                Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">CreditNest?</span>
              </motion.h2>
              <motion.p
              ...
              >
                Everything you need to manage your credit customers, all in one place.
              </motion.p>
            </div>
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent border border-border mb-5">
                <span className="text-[10.5px] font-black uppercase tracking-[0.26em] text-primary">Simple Process</span>
              </div>
              ...
              <p className="text-[15px] text-muted-foreground max-w-md mx-auto leading-[1.80]">Simple 5-step process to get started with CreditNest today</p>
            </motion.div>
                      ...
                      <div className={`flex-1 ${isEven ? 'md:text-right md:pr-16' : 'md:text-left md:pl-16'}`}>
                        <div className="bg-card border border-border rounded-[16px] shadow-sm inline-block text-left md:text-inherit max-w-sm md:max-w-full p-6 hover:shadow-md transition-shadow">
                          <div className="flex items-center gap-2 mb-3">
                            <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-primary/10 text-[10px] font-black tracking-[0.26em] text-primary uppercase">Step {i + 1}</span>
                          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border shadow-sm mb-5">
                ...
                <span className="text-[10.5px] font-black uppercase tracking-[0.26em] text-primary">Customer Stories</span>
              </div>
              <h2 className="text-[2.4rem] md:text-[3rem] font-black mb-4 text-foreground tracking-[-0.022em]">
                Loved by <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">500+ Shop Owners</span>
              </h2>
              <p className="text-muted-foreground text-[15px] max-w-md mx-auto leading-[1.80]">Real stories from real shop owners across India</p>
            </motion.div>
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent border border-border mb-7">
                <span className="text-[10.5px] font-black uppercase tracking-[0.26em] text-primary">Get Started Today</span>
              </div>
              <h2 className="text-[2.2rem] md:text-[2.9rem] font-black text-foreground mb-5 tracking-[-0.022em] leading-tight">
                Ready to modernize<br />your credit management?
              </h2>
              <p className="text-muted-foreground text-[15px] mb-10 max-w-lg mx-auto leading-[1.80]">
                Join thousands of shop owners who manage smarter with CreditNest. Free to start.
              </p>
      ...
      <footer className="relative bg-[#020617] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <div className="size-8 bg-gradient-to-tr from-primary to-secondary rounded-lg flex items-center justify-center text-white font-bold text-sm">
                  CN
                </div>
              ...
              <p className="text-[13px] text-slate-400 leading-[1.80] mb-5 max-w-xs">
                Making credit management simple, fast, and modern for Indian businesses.
              </p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }}>
              <h4 className="font-black mb-6 text-white text-[10.5px] uppercase tracking-[0.30em]">Quick Links</h4>
              <ul className="space-y-3.5">
                {[{ label: 'About Us', href: '#' }, { label: 'Privacy Policy', href: '#' }, { label: 'Contact Us', href: '#' }, { label: 'Terms & Conditions', href: '#' }].map((link) => (
                  <li key={link.label}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.14 }}>
              <h4 className="font-black mb-6 text-white text-[10.5px] uppercase tracking-[0.30em]">Product</h4>
              <ul className="space-y-3.5">
                {[{ label: 'Features', href: '#features' }, { label: 'How it Works', href: '#how-it-works' }, { label: 'Testimonials', href: '#testimonials' }, { label: 'Pricing', href: '#' }].map((link) => (
                  <li key={link.label}>
                    <motion.a href={link.href} whileHover={{ x: 4 }} className="text-[13px] text-slate-400 hover:text-primary transition-colors flex items-center gap-2 group">
                      <span className="w-1 h-1 rounded-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity" />
                      {link.label}
          ...
          >
            <p className="text-[12px] text-slate-500">© 2026 CreditNest. All rights reserved.</p>
            <p className="text-[11px] text-slate-600 font-medium">Made with love for Indian businesses 🇮🇳</p>
          </motion.div>
        </div>
      </footer>
    </div>
